...
export const registerCompanyCategories = async (
    payload: RegisterCompanyCategoriesPayload
): Promise<any> => {
    const response = await axios.post('CompanyCategories/register', payload);
    return response.data;
};

export const updateCompanyCategories = async (
    payload: UpdateCompanyCategoriesPayload
): Promise<any> => {
