...
interface TrackingProductListProps {
    packages: Array<TrackingPackageItem & { stt: number }>;
    loading: boolean;
    onPackageClick: (pkg: TrackingPackageItem) => void;
}
    ...
    return (
        <div className='bg-white rounded-2xl shadow-lg border border-gray-100'>
            <div className='overflow-x-auto'>
                <div className='max-h-[59vh] sm:max-h-[70vh] md:max-h-[60vh] lg:max-h-[53vh] xl:max-h-[57vh] overflow-y-auto'>
