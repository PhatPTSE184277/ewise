        ...
        <div className='bg-white rounded-2xl shadow-xl p-8 animate-slide-in-right border border-gray-100'>
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <button
                    type='submit'
                    disabled={loading}
                    className={`w-full bg-linear-to-r from-primary-600 to-primary-500 text-white font-semibold py-2 rounded-lg shadow hover:from-primary-700 hover:to-primary-700 transition-all flex items-center cursor-pointer justify-center gap-2 ${
