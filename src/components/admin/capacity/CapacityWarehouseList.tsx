...
interface CapacityWarehouseListProps {
    warehouses: WarehouseCapacity[];
    loading: boolean;
}

const CapacityWarehouseList: React.FC<CapacityWarehouseListProps> = ({ warehouses, loading }) => {
    return (
                                ...
                                warehouses.map((wh, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className='py-3 px-4 text-right text-gray-700'>{fmt(wh.maxCapacity)}</td>
                                            <td className='py-3 px-4 text-right text-gray-700'>{fmt(wh.currentCapacity)}</td>
                                            <td className='py-3 px-4 text-right text-gray-700'>{fmt(wh.availableCapacity)}</td>
...
export default CapacityWarehouseList;
